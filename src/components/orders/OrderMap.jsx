...
export function OrderMap({ order, pickupAddress, deliveryAddress }) {
	...
	useEffect(() => {
		...
		if (driverLocation) {
					...
					url: 'data:image/svg+xml;charset=UTF-8,' + encodeURIComponent(`
						<svg width="60" height="60" xmlns="http://www.w3.org/2000/svg">
							...
							<g filter="url(#shadow)">
								...
								<text x="30" y="45" font-size="30" text-anchor="middle">🚗</text>
							</g>
						</svg>
					`),
			...
			// Actualizar cada vez que cambia driverLocation
			const interval = setInterval(updateDriverPosition, 5000);
			
			// Cleanup del intervalo cuando el componente se desmonte o cambien las dependencias
