...
export function CreateClientForm({ onSubmit, onClose, currentUser, localConfigs, initialData }: CreateClientFormProps) {
	...
	const [local, setLocal] = useState<Local>(initialData?.local || initialLocal);
